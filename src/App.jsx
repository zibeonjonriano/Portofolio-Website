...
function ProyekBox({ proyek }) {
  ...
  return (
    <div className="p-4 bg-zinc-800 rounded-2xl" data-aos="fade-up" data-aos-duration="1000" data-aos-delay={proyek.dad}  data-aos-once="true">
      ...
      <div>
        ...
        <div className="mt-8 text-center">
          <a className={`bg-violet-700 p-3 rounded-2xl block border border-zinc-600 hover:bg-violet-600 ${!proyek.link ? 'pointer-events-none opacity-50' : ''}`}
...
function App() {
  ...
  return (
    <>
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-0 md:pt-18 px-10 xl:gap-0 gap-6 grid-cols-1">
              <div className="animate__animated animate__fadeInUp animate__delay-3s">
                <div className="flex items-center gap-3 mb-6 
                      bg-white/10 backdrop-blur-sm 
                      border-[0.1px] border-white/30 
                      shadow-[inset_0_0_8px_1px_hsl(0,0%,1%)] 
                      w-fit p-4 rounded-4xl">
                ...
                <div className="flex items-center sm:gap-4 gap-2">
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-violet-700 p-4 rounded-3xl hover:bg-violet-500 text-sm sm:text-base font-medium"
                  >
                    Download CV <i className="ri-download-line ri-lg"></i>
                  </a>

                  <a href="#proyek" className="bg-zinc-700 p-4 rounded-3xl hover:bg-zinc-500 text-sm sm:text-base font-medium">
              ...
              <img
                ...
                className="w-[325px] rounded-[80px] md:ml-auto transition duration-300 animate__animated animate__fadeInUp animate__delay-4s"
              />
            </div>

            {/* tentang */}
            <div className="tentang mt-20 py-5 px-10" id="tentang">
              <div className="xl:w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-800 rounded-4xl"
              ...
              <div className="tools mt-32" id="alat">
                ...
                <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
                  {listTools.map((tool) => (
                    <div className="flex items-center gap-2 p-3 border border-zinc-600 rounded-xl hover:bg-zinc-800 group" key={tool.td} data-aos="fade-up" data-aos-duration="1000" data-aos-delay={tool.dad}  data-aos-once="true">
            ...
            <div className="kontak mt-32 sm:p-10 p-0 p-10" id="kontak">
              ...
              <form action="https://formsubmit.co/zibeonjonriano21@gmail.com" method="POST"  className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-xl" autoComplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
